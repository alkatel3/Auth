    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDto)
        {
            ...
            request.AddJsonBody(new
            {
                ...
                template_uuid = "782a1fb1-e742-45ee-81e0-305b705e166e",
            ...
            {
                return StatusCode((int)response.StatusCode, new AuthResponseDto
                {
                    IsSuccess = false,
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            var tokenParameters = new TokenValidationParameters
            {
                ...
                IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetSection("JwtSetting").GetSection("SecretKey").Value!)),
                ValidateLifetime = false
            };

            var tokenHandler = new JwtSecurityTokenHandler();
            var principal = tokenHandler.ValidateToken(token, tokenParameters, out SecurityToken validatedToken);
